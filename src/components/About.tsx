      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-16 fade-in-up ${isVisible ? 'animate' : ''}`}>
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            From passionate learner to Lead Frontend Developer, here's how my story unfolded
          </p>
        </div>
            ...
            <div className="neu-elevated p-8">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  of building exceptional user experiences. With over 6 years in frontend development, 
                  I've had the privilege of working with diverse teams and creating solutions that impact millions of users.
                </p>
                <p>
                  As a Lead Frontend Developer, I bridge the gap between design and functionality, 
                ...
                <p>
                  Beyond coding, I'm passionate about mentoring emerging developers and contributing to 
                  the tech community. I believe in continuous learning and sharing knowledge to elevate 
